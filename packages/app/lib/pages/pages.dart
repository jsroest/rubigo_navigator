...
Map<Pages, RubigoController<Pages>> controllers(BuildContext context) {
  return {
    Pages.s100MainMenu: context.read(s100MainMenuControllerProvider),
    Pages.s200SelectItem: context.read(s200SelectItemControllerProvider),
    Pages.s210PerformCheck: context.read(s210PerformCheckControllerProvider),
    Pages.s220AllRowsDone: context.read(s220AllRowsDoneControllerProvider),
    Pages.s230NoRowsFound: context.read(s230NoRowsFoundControllerProvider),
    Pages.s900Settings: context.read(s900SettingsControllerProvider),
  };
}
