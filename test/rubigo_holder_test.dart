...
void main() {
  test(
    ...
    () {
      ...
      final controller1 = holder.get(ControllerScreens1.new);
      final controller2 = holder.get(ControllerScreens2.new);
      ...
      final tmp1 = holder.get(ControllerScreens1.new);
      ...
      final tmp2 = holder.get(ControllerScreens2.new);
